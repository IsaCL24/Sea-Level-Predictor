...
def draw_plot():
    ...
    plt.plot(years_extended, sea_level_pred, 'r', label='Best fit line (1880-2013)')
    ...
    # Calculate y values using the recent regression equation
    sea_level_pred_recent = slope_recent * years_recent + intercept_recent
    
    # Plot the second line of best fit
    plt.plot(years_recent, sea_level_pred_recent, 'g', label='Best fit line (2000-2013)')
